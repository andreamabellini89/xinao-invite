            ...
            return(
              <div key={evt.id} style={{background:T.white,border:`1px solid ${T.n200}`,borderRadius:4,overflow:'visible',position:'relative'}}>
                ...
                <div style={{position:'absolute',top:evt.cover_image_url?88:8,right:8}}>
                  ...
                  {menuOpen===evt.id&&(
                    <div style={{position:'absolute',top:31,right:0,background:T.white,zIndex:9999,border:`1px solid ${T.n200}`,borderRadius:4,boxShadow:'0 4px 20px rgba(0,0,0,0.1)',minWidth:160,overflow:'hidden'}}>
