      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'24px 16px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(280px,1fr))',gap:12}}>
          {sorted.map(evt=>{
            ...
            return(
              <div key={evt.id} style={{background:T.white,border:`1px solid ${T.n200}`,borderRadius:4,overflow:'visible',position:'relative',zIndex:menuOpen===evt.id?200:undefined}}>
                ...
                <div style={{position:'absolute',top:evt.cover_image_url?88:8,right:8}}>
                  ...
                  {menuOpen===evt.id&&(
                    <div style={{position:'absolute',top:31,right:0,background:T.white,border:`1px solid ${T.n200}`,borderRadius:4,boxShadow:'0 4px 20px rgba(0,0,0,0.1)',zIndex:300,minWidth:160,overflow:'hidden'}}>
                      ...
                      {evt.event_number?(
                        ...
                        <div style={{padding:'10px 14px',borderBottom:`1px solid ${T.n100}`,fontSize:11,fontFamily:'sans-serif',color:T.n300}}>⊞  Set event number for QR</div>
                      )}
